        ...
        */
        value: function _executeCommand(command, callback) {
            return new _promise2.default(function (resolve, reject) {
                ...
                throw new Error(_chalk2.default.red(error) + _chalk2.default.yellow('Make sure you\'re running the command from the repo folder, or you using the --username and --repo flags.'));
            });
        }
        ...
        */
        ...
        value: function _repo(callback) {
            return this._executeCommand('git config remote.origin.url', function (repo) {
                var repoPath = repo.replace(/([^:]*:)|\.[^.]+$/g, '').split('/');
                var user = repoPath[0];
                var name = repoPath[1];
